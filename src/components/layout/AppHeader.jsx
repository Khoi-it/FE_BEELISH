...
import { ROUTES, routeHash } from '../../constants/routes.js'
  ...
  return (
      <header
          ...
          <div className="flex items-center gap-4 shrink-0">
              ...
              <nav className="hidden md:flex gap-2 items-center">
                {navItems.map(({ label, route }) => (
                  <a key={route} href={routeHash(route)} className="px-3 py-1.5 text-sm font-bold hover:bg-primary/20 rounded-lg">
                    {label}
                  </a>
                ))}
              </nav>
          ...
          <div className="flex items-center gap-2 md:gap-3 shrink-0">
              ...
              {/*User*/}
              <a href={routeHash(ROUTES.PROFILE)} className="flex items-center gap-2 pl-2 md:pl-3 border-l-2 border-border-dark/10">
                  ...
                  <div className="w-8 h-8 md:w-9 md:h-9 bg-primary chunky-border rounded-full overflow-hidden">
                      <img alt="User Avatar"
