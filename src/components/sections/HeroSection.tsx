  ...
  return (
    <section className="grid grid-cols-1 items-center gap-12 py-16 md:py-24 lg:grid-cols-2">
      <div className="flex flex-col gap-8">
        <div
          className={`mb-2 inline-block self-start rounded-full bg-white px-4 py-1 text-xs font-black tracking-widest uppercase border-[3px] border-[#283f3b] shadow-[4px_4px_0_0_#283f3b]`}
        >
      ...
      <div className="relative flex items-center justify-center">
        ...
        <div
          className={`flex aspect-square w-full items-center justify-center overflow-hidden rounded-3xl bg-white border-[3px] border-[#283f3b] shadow-[8px_8px_0_0_#283f3b]`}
        >
          <img
