      ...
      <div className="mx-auto max-w-[1440px] px-4 py-6">
        ...
        <div className="space-y-8">
          <section className="relative flex flex-col gap-8 overflow-hidden rounded-[2rem] border-4 border-[#283f3b] bg-white p-8 shadow-[8px_8px_0px_0px_#283f3b] md:flex-row md:items-center">
            ...
            <div className="flex-1 space-y-2 text-center md:text-left">
              <div className="flex flex-col gap-4 md:flex-row md:items-center">
                <h1 className="text-4xl font-black uppercase tracking-tight">Nguyễn Văn Minh</h1>
            ...
            <div className="flex flex-col gap-3 md:ml-2">
              <button className="rounded-xl border-4 border-[#283f3b] bg-[#ffbf00] px-8 py-3 text-center font-black uppercase shadow-[4px_4px_0px_0px_#283f3b] transition-all active:translate-y-1 active:shadow-none">
                Sửa Hồ Sơ
              </button>
              <button className="rounded-xl border-4 border-[#283f3b] bg-white px-8 py-3 text-center font-black uppercase shadow-[4px_4px_0px_0px_#283f3b] transition-all active:translate-y-1 active:shadow-none">
                ĐĂNG XUẤT
              </button>
            </div>
          </section>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
            <StatCard label="Số từ đã học" value="1,240" subValue="+12 hôm nay" subValueClassName="text-tertiary" />
            <StatCard
            ...
            />
            <StatCard label="Tổng XP" value="24,500" subValue="Level 24" subValueClassName="text-[#ffbf00]" />
